    ...
    public partial class Form1 : Form
    {
        ...
        private void ResimKutusu_Click(object? sender, EventArgs e)
        {
            ...
            if (aciklar.Count == 1 && aciklar[0] == tiklanan)
                return;  // metodun geriye kalan kodlarý okunmaz

            // yeni bir resim kutusuna týklandýgýnda önceden açýlanlarýn kapanmasý
            if (aciklar.Count == 2)
            {
                AciklariKapat();
            }
            ...
            // 2. kartý actýgýnda yapýlacak eþleþme kontrolü
